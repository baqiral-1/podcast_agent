    ...
    return StrategyEpisode.model_validate(
        {
            ...
            "episode_spine": {
                "listener_problem": "How does the hinge turn?",
                "episode_answer": "The hinge redirects the episode.",
    ...
    return EpisodePlan.model_validate(
        {
            ...
            "scene_cards": [
                ...
                },
                {
                    ...
                    "beat_change": "The hinge becomes visible.",
                    "entry_image": "Image 2",
                ...
                },
                {
                    ...
                    "dominant_primitive_id": "primitive_1",
                    "spine_relation": "turn",
                    "beat_change": "The consequence starts to cash out.",
                    "entry_image": "Image 3",
                ...
                },
                {
                    ...
                    "beat_change": "The consequence lands.",
                    "entry_image": "Image 4",
