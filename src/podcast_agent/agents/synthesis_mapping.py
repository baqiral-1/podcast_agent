...
class SynthesisMappingAgent(Agent):
    ...
    instructions = (
        ...
        "Generate between 60 and 80 insights in the insights array. For each insight, "
        "recommend a narrative treatment:\n"
        ...
        "- Generate between 7 and 9 merged narratives in merged_narratives so downstream "
        ...
        "- Each merged narrative must be 350 words or fewer total\n"
