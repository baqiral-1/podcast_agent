...
class ThemeDecompositionAgent(Agent):
    """Decomposes a user theme into 20-25 strong thematic axes spanning all books.
    ...
    instructions = (
        ...
        "decompose the theme into 20-25 strong analytical lenses (thematic axes).\n\n"
        "Each axis should be:\n"
        ...
        "- description: 3-4 sentences explaining what this axis covers\n"
        "- guiding_questions: 8-10 questions this axis seeks to answer across the books\n"
