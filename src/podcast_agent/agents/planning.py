...
class EpisodePlanningAgent(Agent):
    ...
    instructions = (
        ...
        "3. Materially realize each assigned merged narrative in the beat plan using its source_passage_ids.\n"
        "4. Target runtime is 140 minutes with a hard planning floor of 125 minutes.\n"
        "5. Include 70-80 beats, each designed to sustain long-form pacing.\n"
        ...
        " help contextualize and structure the beats"
