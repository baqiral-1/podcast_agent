...
class PassageExtractionAgent(Agent):
    ...
    instructions = (
        ...
        "The number of passages MUST equal the number of input candidates. "
        "Every input passage_id MUST appear exactly once in passages. Missing even one input passage, "
        "duplicating any passage_id, or changing the order is invalid. Preserve the input order.\n"
