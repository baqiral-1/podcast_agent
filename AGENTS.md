...
- Use this structure:
  Description
  Intent:
    - 2 bullet points summarizing intent (3 if necessary). Keep each bullet under 20 words.
    - ...

  Changes:
    - 3 bullet points summarizing changes (5 maximum if necessary). Keep each bullet under 25 words.
