...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Resume an existing run from persisted narrative strategy onward by "
            "rebuilding selected primitives, episode architecture, planning, and "
            "production from tagged primitives with strict integrity checks."
        )
    )
    parser.add_argument(
        "--project-id",
